...
var AuthorWhere = struct {
	...
	ID:        whereHelperuint64{field: "`authors`.`id`"},
...
var (
	authorAllColumns            = []string{"id", "first_name", "last_name"}
...
func FindAuthor(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Author, error) {
	authorObj := &Author{}
...
func AuthorExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
